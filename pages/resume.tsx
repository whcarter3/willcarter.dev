      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6 flex justify-between items-center">
            ...
            <Button onClick={handleDownload} className="px-6 py-3">
              Download PDF
            </Button>
          </div>
          ...
          <div className="resume-content prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-base leading-relaxed">
                TypeScript, JavaScript (ES2015+), React, Next.js, Redux, Xstate, Jotai, HTML5, CSS3, Tailwind CSS, SCSS, Material UI, React-aria, ShadCN, Accessibility (ARIA, WCAG), Performance Optimization, Google Lighthouse, Storybook, Jest, Cypress, ProseMirror, SQLite, Prisma, REST APIs, GraphQL, Tauri, Vue.js, Angular, jQuery, npm, Yarn, Vite, Webpack, Monorepo Tooling (nx), Github Actions, CI/CD, ESLint, Prettier
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="mb-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm text-gray-600 whitespace-nowrap ml-4">May 2025 - Present</span>
                </div>
              ...
              <div className="mb-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm text-gray-600 whitespace-nowrap ml-4">Mar 2023 - May 2025</span>
                </div>
                <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <div className="mb-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm text-gray-600 whitespace-nowrap ml-4">Apr 2022 - Nov 2022</span>
                </div>
                <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <div className="mb-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm text-gray-600 whitespace-nowrap ml-4">Aug 2019 - Mar 2022</span>
                </div>
                <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <section className="mb-8">
              ...
              <div className="mb-4">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm text-gray-600 whitespace-nowrap ml-4">Apr 2017 - Mar 2019</span>
                </div>
              </div>
              <div className="mb-4">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-xl font-heading">Web Developer, Looking Design</h3>
                  <span className="text-sm text-gray-600 whitespace-nowrap ml-4">Apr 2015 - Apr 2017</span>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="mb-4">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm text-gray-600 whitespace-nowrap ml-4">2014 - 2015</span>
                </div>
              </div>
              <div className="mb-4">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-sm text-gray-600 whitespace-nowrap ml-4">2006 - 2011</span>
                </div>
              </div>
            </section>
          </div>
