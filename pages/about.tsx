      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-14">
        ...
        <div className="col-span-2">
          ...
          <p className="mb-5">
            ...
            collaborating with project stakeholders including project
            managers, designers, and marketing teams in order to turn
            designs into responsive, mobile-friendly websites that
            perform well on all devices.
          </p>
          <p className="mb-5">
            In addition to my technical skills, I am an advocate for
            accessibility. I believe that the web should be accessible
            to everyone, regardless of their abilities, and I strive
            to ensure that all of the websites I build are inclusive
          ...
          <p className="mb-5">
            ...
            <em>(@zzayphod if you&apos;re curious)</em>. These days, I
            am more of a casual gamer, but I still enjoy playing games
            with my friends and family.
          </p>

          <p className="mb-5">
            Let&apos;s see how you and I can work together! Make sure
            to drop me a{' '}
            <Link
              href="/contact"
